...
\begin{figure*}[ht]
    ...
    \caption{Worked example of the communicative stress test pipeline. (a) An excerpt from a real conversation between a participant agent (SI $= 2.92$) and the Neutral Acquaintance probe. Risk-relevant language emerges naturally in casual small talk. (b) Dictionary scoring of agent turns, with hits color-coded by category. (c) Aggregation from turn-level hits to conversation composite, person-level score, and clinical association.}
